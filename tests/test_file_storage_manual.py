...
def test_file_storage_manual():
    ...
    # patch.object ensures settings.STORAGE_PATH is the temp dir even if the
    # settings singleton was already initialised before this test ran
    with patch.object(app_settings, 'STORAGE_PATH', temp_dir):
        try:
